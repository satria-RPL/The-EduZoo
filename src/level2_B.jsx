...
import gajah1 from "./assets/puzzle_hewan/gajah (1).png";
import gajah2 from "./assets/puzzle_hewan/gajah (2).png";
import gajah3 from "./assets/puzzle_hewan/gajah (3).png";
import gajah4 from "./assets/puzzle_hewan/gajah (4).png";
...
// Semua potongan hewan lain (pilih 4 random, tanpa jerapah)
const allOtherPieces = [
  ...
  { img: gajah1 },{ img: gajah2 }, { img: gajah3 }, { img: gajah4 }, // dummy, tidak dipakai di drag
];
...
export default function Level2Puzzle({ onBackToGameCanvas }) {
  // Audio refs
  ...
  // Play sound pjerapah.mp3 saat komponen mount
  useEffect(() => {
  ...
  useEffect(() => {
    if ([0, 1, 2, 3].every((idx) => slots[idx] && slots[idx].id === idx)) {
      sessionStorage.setItem("level2_B_completed", "1");
  ...
  return (
    <div className="level-puzzle-container">
      ...
      {/* Audio */}
      <audio ref={puzzleAudioRef} src={pjerapahSound} />
