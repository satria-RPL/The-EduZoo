...
import jerapah1 from "./assets/hewan/Jerapah 1.png";
import jerapah2 from "./assets/hewan/Jerapah 2.png";
import jerapahSound from "./assets/suara_hewan/jerapah.mp3";
...
// Helper untuk random huruf selain J, E, R, A, P, H (max 3x)
const allButtons = [
  { huruf: "A", img: buttonA },
  { huruf: "B", img: buttonB },
  { huruf: "C", img: buttonC },
...
// Kata kunci: J, E, R, A, P, A, H (7 huruf)
const kunci = [
  { huruf: "J", img: buttonJ },
  { huruf: "E", img: buttonE },
  { huruf: "R", img: buttonR },
...
// Fungsi untuk generate 8 huruf drag (7 kunci + 1 random, tidak double > 3)
...
export default function Level2Drag({ onBackToGameCanvas }) {
  ...
  const [dropSlots, setDropSlots] = useState(Array(7).fill(null));
  const [draggedIdx, setDraggedIdx] = useState(null);
  const [starParticles, setStarParticles] = useState(Array(7).fill(false));
  const [showJerapah2, setShowJerapah2] = useState(false);
  ...
  useEffect(() => {
    if (
      ...
      sessionStorage.setItem("level2_A_completed", "1");
  ...
  return (
    <div className="levelA-drag-container">
      ...
      <div className="level-label-roww">
        <div className="level-label label-level">Level 2</div>
      ...
      {/* Panel utama dengan jerapah */}
      <div className="hewan-panel" style={{ left: "23%", top: "160px" }}>
        <img
          src={showJerapah2 ? jerapah2 : hover ? jerapah2 : jerapah1}
          alt="Jerapah"
          className={`hewan-img${hover ? " hewan-img-besar" : ""}`}
          onMouseEnter={handleMouseEnter}
          onMouseLeave={handleMouseLeave}
        />
        <audio ref={audioRef} src={jerapahSound} />
      </div>
