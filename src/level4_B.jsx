...
import pgagakSound from "./assets/sound_puzzle/pgagak.mp3";
import maskot1 from "./assets/maskot1.png";
import { useState, useRef, useEffect } from "react";

// Gagak (kunci slot drop)
const gagakPieces = [
  { id: 0, img: gagak1 },
  { id: 1, img: gagak2 },
  { id: 2, img: gagak3 },
...
// Semua potongan hewan lain (pilih 4 random, tanpa gagak)
...
export default function Level4Puzzle({ onBackToGameCanvas }) {
  ...
  useEffect(() => {
    if ([0, 1, 2, 3].every((idx) => slots[idx] && slots[idx].id === idx)) {
      sessionStorage.setItem("level4_B_completed", "1"); // ganti X sesuai level
  ...
  return (
    <div className="level-puzzle-container">
      ...
      <audio ref={puzzleAudioRef} src={pgagakSound} />
