...
import ppausSound from "./assets/sound_puzzle/ppaus.mp3";
...
// Semua potongan hewan lain (pilih 4 random, tanpa paus)
...
export default function Level5Puzzle({ onBackToGameCanvas }) {
  ...
  useEffect(() => {
    if ([0, 1, 2, 3].every((idx) => slots[idx] && slots[idx].id === idx)) {
      sessionStorage.setItem("level5_B_completed", "1"); // ganti X sesuai level
  ...
  return (
    <div className="level-puzzle-container">
      ...
      <audio ref={puzzleAudioRef} src={ppausSound} />
