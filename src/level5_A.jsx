...
import paus1 from "./assets/hewan/paus 1.png";
import paus2 from "./assets/hewan/paus 2.png";
import pausSound from "./assets/suara_hewan/paus.mp3";
...
// Fungsi untuk generate 8 huruf drag (4 kunci + 4 random, tidak double > 3)
...
export default function Level5Drag({ onBackToGameCanvas, onWin }) {
  ...
  const [dropSlots, setDropSlots] = useState(Array(4).fill(null)); // 4 slot drop

  // Drag and drop logic
  const [draggedIdx, setDraggedIdx] = useState(null);
  const [starParticles, setStarParticles] = useState([false, false, false, false]);
  const [showPaus2, setShowPaus2] = useState(false);
      ...
      setDropSlots(newSlots);
       ...
       useEffect(() => {
         if (
           ...
           sessionStorage.setItem("level5_A_completed", "1");
  ...
  return (
    <div className="levelA-drag-container">
      ...
      <div className="level-label-roww">
        <div className="level-label label-level">Level 5</div>
